...
2  FLAGS=S VOLUME=SYS2W1 SYS3.SYS2.PARMLIB
3  FLAGS=D VOLUME=SYS2W1 SYS3.SYS2.LOCAL.PARMLIB
```
...
```
$ inventory active
STC03801 CICSPROD  TYPE=STC ASID=0043 OWNER=CICSUSR JOBCLASS=STC SVCCLASS=SYSSTC SYSTEM=SYS2
STC00002 JES2  TYPE=STC ASID=0002 OWNER=STCUSR JOBCLASS=STC SVCCLASS=SYSSTC SYSTEM=SYS2
JOB01234 PAYROLL  TYPE=JOB ASID=0091 OWNER=PAYUSR JOBCLASS=A SVCCLASS=BATCH SYSTEM=SYS2
```
...
```
$ inventory jes2parm
CKPTDEF  CKPT1=(DSNAME=SYS1.SYS2.HASPCKPT, VOLSER=SYS2W1, INUSE=YES),DUPLEX=ON  [JES2PARM]
CKPTSPACE  BERTNUM=6500,BERTWARN=80  [JES2PARM]
FSS(PRINTOFF)    [JES2PARM]
INCLUDE  DSNAME=SYS1.SYS2.PARMLIB(JES2NJE),VOLSER=SYS2W1  [JES2PARM]
INIT(1)  NAME=1,CLASS=QE,START=  [JES2PARM]
NETSRV(1)  SOCKET=LOCAL  [JES2NJE]
NODE(1)  NAME=SYSP,PATHMGR=NO,NETSRV=1  [JES2NJE]
SOCKET(SYSP)  IPADDR=SYSP.EXAMPLE.COM,PORT=175,NODE=1  [JES2NJE]
```
