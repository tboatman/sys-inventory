...
own documentation and a real reply from this site:
    ...
    ACTIVE WORKLOAD MANAGEMENT SERVICE POLICY NAME: XYZPROD1
    ACTIVATED: 2023/09/11  AT: 12:47:50  BY: CSTSYP    FROM: SYSB
    DESCRIPTION: XYZ Production Service Policy
    RELATED SERVICE DEFINITION NAME: xyzprod1
    INSTALLED: 2023/09/11  AT: 12:45:09  BY: CSTSYP    FROM: SYSB
